        ...
        return [
            ...
            },
            {
                ...
                checks: [
                    ...
                    { id: 'ci-goods',       text: `Goods: extract the description wording, quantity, and package count — confirm description matches LC, quantity is ${(g.quantity || 0).toLocaleString()} ${g.quantityUnit || 'kg'}, ${g.packageCount || '?'} ${g.packageType || 'packages'}, origin ${g.origin || '?'}` },
