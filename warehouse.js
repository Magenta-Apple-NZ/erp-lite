// ── Warehouse module ──
// Handles #warehouse view (delegates to stock.js) and the Imports / Forecast views
...
const Warehouse = (() => {
    ...
    // ── Main render ──
    // The stocktake editor and the reconcile / running-stock / consumables
    // panels were replaced by the stock engine (stock.js + /api/stock/*).
    // Warehouse delegates to it; Imports & Forecast stay in this module.
    async function render(container) {
        await Stock.renderWarehouse(container);
    }
